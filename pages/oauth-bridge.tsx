...
// Pages Router version of the OAuth deep-link bridge.
// Receives the browser OAuth redirect and forwards it to the desktop app via metapip://, then attempts to close.
export default function OAuthBridge() {
  ...
  useEffect(() => {
    try {
      ...
      // Try to launch the desktop app via deep link
